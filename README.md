...
│
├── ryu/
│   └── Ryu SDN controller Python code
│
├── mininet/
│   └── Mininet topology and traffic generation scripts
│
├── backend/
│   ├── model/
│   │   └── Pre-trained 30pktTCNET model for inference
│   │
│   ├── database/
│   │   └── Inference logs (SQLite/CSV)
│   │
│   └── app.py
│       └── REST endpoint for classification
│
├── web-dashboard/
│   └── Traffic classification visualization UI
│
└── docs/
